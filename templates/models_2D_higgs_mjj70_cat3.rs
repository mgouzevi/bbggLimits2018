CMS_hhbbgg_13TeV_mgg_bkg_par1_cat3[0.9, -100, 100];

mgg_sig_m0_cat3[125., 122, 127];
mgg_sig_sigma_cat3[2.8, 2.1, 5.0];
...
mgg_hig_sigma_ggh_cat3[2.8, 2.1, 5.0];
...
mgg_hig_sigma_tth_cat3[2.8, 2.1, 5.0];
...
mgg_hig_sigma_vh_cat3[2.8, 2.1, 5.0];
...
mgg_hig_sigma_vbf_cat3[2.8, 2.1, 5.0];
...
mgg_hig_sigma_bbh_cat3[2.8, 2.1, 5.0];
...
mjj_sig_m0_cat3[122.0, 115, 130];
mjj_sig_sigma_cat3[20.0, 10.0, 60.0];
mjj_sig_alpha1_cat3[0.3, 0.2, 2.0];
mjj_sig_n1_cat3[1.0, 0.5, 10.0];
mjj_sig_alpha2_cat3[3, 0.5, 2.0];
mjj_sig_n2_cat3[5.0, 1.0, 100.0];
mjj_sig_gm0_cat3[122.0, 110, 130];
mjj_sig_gsigma_cat3[25.0, 10.0, 60.0];
mjj_sig_frac_cat3[0.1, 0, 1];

mjjGaussSig_cat3 = Gaussian(mjj, mjj_sig_gm0_cat3, mjj_sig_gsigma_cat3);
mjjCBSig_cat3 = CBShape(mjj, mjj_sig_m0_cat3, mjj_sig_sigma_cat3, mjj_sig_alpha1_cat3, mjj_sig_n1_cat3);
mjjSig_cat3 = AddPdf(mjjGaussSig_cat3, mjjCBSig_cat3, mjj_sig_frac_cat3);


CMS_hhbbgg_13TeV_mjj_bkg_par1_cat3[0.9, -100, 100];
