CMS_hhbbgg_13TeV_mgg_bkg_par1_cat0[0.9, -100, 100];

mgg_sig_m0_cat0[125., 122, 127];
mgg_sig_sigma_cat0[2.8, 2.1, 5.0];
mgg_sig_alpha1_cat0[1.5, 1.00, 10.0];
mgg_sig_n1_cat0[2.0, 0.1, 10.0];
mgg_sig_alpha2_cat0[1.5, 1.00, 10.0];
...
mgg_hig_sigma_ggh_cat0[2.8, 2.1, 5.0];
mgg_hig_alpha1_ggh_cat0[1.5, 1.00, 10.0];
mgg_hig_n1_ggh_cat0[2.0, 0.1, 10.0];
mgg_hig_alpha2_ggh_cat0[1.5, 1.00, 10.0];
...
mgg_hig_sigma_tth_cat0[2.8, 2.1, 5.0];
mgg_hig_alpha1_tth_cat0[1.5, 1.00, 10.0];
mgg_hig_n1_tth_cat0[2.0, 0.1, 10.0];
mgg_hig_alpha2_tth_cat0[1.5, 1.00, 10.0];
...
mgg_hig_sigma_vh_cat0[2.8, 2.1, 5.0];
mgg_hig_alpha1_vh_cat0[1.5, 1.00, 10.0];
mgg_hig_n1_vh_cat0[2.0, 0.1, 10.0];
mgg_hig_alpha2_vh_cat0[1.5, 1.00, 10.0];
...
mgg_hig_sigma_vbf_cat0[2.8, 2.1, 5.0];
mgg_hig_alpha1_vbf_cat0[1.5, 1.00, 10.0];
mgg_hig_n1_vbf_cat0[2.0, 0.1, 10.0];
mgg_hig_alpha2_vbf_cat0[1.5, 1.00, 10.0];
...
mgg_hig_sigma_bbh_cat0[2.8, 2.1, 5.0];
mgg_hig_alpha1_bbh_cat0[1.5, 1.00, 10.0];
mgg_hig_n1_bbh_cat0[2.0, 0.1, 10.0];
mgg_hig_alpha2_bbh_cat0[1.5, 1.00, 10.0];
...
CMS_hhbbgg_13TeV_mjj_bkg_par1_cat0[0.9, -100, 100];
