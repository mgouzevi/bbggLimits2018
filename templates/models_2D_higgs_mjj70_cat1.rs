CMS_hhbbgg_13TeV_mgg_bkg_par1_cat1[0.9, -100, 100];

mgg_sig_m0_cat1[125., 122, 127];
mgg_sig_sigma_cat1[2.8, 2.1, 5.0];
mgg_sig_alpha1_cat1[1.5, 1.00, 10.0];
mgg_sig_n1_cat1[2.0, 0.1, 10.0];
mgg_sig_alpha2_cat1[1.5, 1.00, 10.0];
...
mgg_hig_m0_ggh_cat1[124.2, 123, 125.0];
mgg_hig_sigma_ggh_cat1[2.8, 2.1, 5.0];
mgg_hig_alpha1_ggh_cat1[1.5, 1.00, 10.0];
mgg_hig_n1_ggh_cat1[2.0, 0.1, 10.0];
mgg_hig_alpha2_ggh_cat1[1.5, 1.00, 10.0];
...
mgg_hig_m0_tth_cat1[124.2, 123, 125.0];
mgg_hig_sigma_tth_cat1[2.8, 2.1, 5.0];
mgg_hig_alpha1_tth_cat1[1.5, 1.00, 10.0];
mgg_hig_n1_tth_cat1[2.0, 0.1, 10.0];
mgg_hig_alpha2_tth_cat1[1.5, 1.00, 10.0];
...
mgg_hig_m0_vh_cat1[124.2, 123, 125.0];
mgg_hig_sigma_vh_cat1[2.8, 2.1, 5.0];
mgg_hig_alpha1_vh_cat1[1.5, 1.00, 10.0];
mgg_hig_n1_vh_cat1[2.0, 0.1, 10.0];
mgg_hig_alpha2_vh_cat1[1.5, 1.00, 10.0];
...
mgg_hig_m0_vbf_cat1[124.2, 123, 125.0];
mgg_hig_sigma_vbf_cat1[2.8, 2.1, 5.0];
mgg_hig_alpha1_vbf_cat1[1.5, 1.00, 10.0];
mgg_hig_n1_vbf_cat1[2.0, 0.1, 10.0];
mgg_hig_alpha2_vbf_cat1[1.5, 1.00, 10.0];
...
mgg_hig_m0_bbh_cat1[124.2, 123, 125.0];
mgg_hig_sigma_bbh_cat1[2.8, 2.1, 5.0];
mgg_hig_alpha1_bbh_cat1[1.5, 1.00, 10.0];
mgg_hig_n1_bbh_cat1[2.0, 0.1, 10.0];
mgg_hig_alpha2_bbh_cat1[1.5, 1.00, 10.0];
...
CMS_hhbbgg_13TeV_mjj_bkg_par1_cat1[0.9, -100, 100];
